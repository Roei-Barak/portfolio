...
import { Terminal, Lock, Database, Shield, Phone, Binary } from 'lucide-react';
...
const riddles: Riddle[] = [
  ...
  },
  {
    ...
    description: "This C program has a vulnerability. Find the input that will overflow the buffer and change the 'isAdmin' variable to 1:\n\nvoid check_password() {\n    char buffer[8];\n    int isAdmin = 0;\n    \n    gets(buffer); // Vulnerable function\n    \n    if(isAdmin) {\n        printf(\"Access granted!\");\n    }\n}\n\nWhat input would you provide to gain admin access?",
    hint: "Think about memory layout and how many characters you need to overflow into isAdmin...",
    answer: "AAAAAAAAA",
    icon: Binary,
    type: "buffer"
  }
